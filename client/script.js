...
/////index.css for my original solution
...
const repeatMyParam = () => {
  return axios
    .get(`http://localhost:3000/repeat/${SOMEPARAM}`)
    .then((res) => res.data);
};
...
function req(event) {
  axios
    .get(`http://localhost:3000/repeat?myquery=golf-is-the-greatest-sport`)
    .then(({ data }) => console.log(data));
}
let querBtn = document.querySelector(`#query-button`);
querBtn.addEventListener("click", req);
////////////////
//INTERMEDIATE//
////////////////
